...
config = {
    "alpha_vantage": {
        "key": "END8K2CL2J4RVZWT", # you can use the demo API key for this project, but please make sure to get your own API key at https://www.alphavantage.co/support/#api-key
        "symbol": args.symbol,
        "outputsize": "full",
        "key_close": "4. close",
    },
...
def download_data(config):
    ts = TimeSeries(key='END8K2CL2J4RVZWT')
